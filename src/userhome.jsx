...
function Userhome() {
    ...
    return (
        ...
        <div>
                     ...
                     <a href="https://cybertrainer-latest-1.onrender.com/ar" target="_blank"><Button className='bg-lime-500 py-3 px-4  text-xl rounded border border-lime-500 hover:text-lime-500 hover:bg-slate-950 ' >Learn</Button></a>
