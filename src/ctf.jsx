...
const Ctf = () => {
  ...
  useEffect(()=>{
     axios.get('https://cybertrainer-latest-1.onrender.com/ctf/')
     .then((res)=>{
        setdata(res.data)
     })
     .catch((err)=>{
  ...
  useEffect(()=>{
    axios.get('https://cybertrainer-latest-1.onrender.com/cactf/')
    .then((res)=>{
       setcat(res.data)
    })
    .catch((err)=>{
 ...
 function geet(s){
    axios.post('https://cybertrainer-latest-1.onrender.com/ctf/',{'cn':s})
    .then((res)=>{
       setdata(res.data)
    })
    .catch((err)=>{
